...
from pr_agent.tools.pr_prompting_agent import MockAIHandler, MockGitProvider, PRPromptingAgent
...
def build_agent(pr_url: str) -> PRPromptingAgent:
    """
    Construct a PRPromptingAgent for a given PR URL.

    Swap MockGitProvider / MockAIHandler for the real implementations, e.g.:
